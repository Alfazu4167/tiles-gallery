...
const Navbar = () => {
    const li = <>
        <li className='font-semibold block'><NavLink href={'/'}>Home</NavLink></li>
        <li className='font-semibold block'><NavLink href={'/tiles'}>All Tiles</NavLink></li>
        <li className='font-semibold block'><NavLink href={'/profile'}>My Profile</NavLink></li>
    </>
    return (
